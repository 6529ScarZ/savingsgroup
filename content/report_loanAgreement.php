<section class="content-header">
               ...
               if($method=='approve'){?>
            <h1><img src='images/icon-57.ico' width='35'><font color='blue'>  สัญญาเงินกู้ที่ผ่านการอนุมัติ </font></h1> 
            <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
              <li class="active"><i class="fa fa-edit"></i> สัญญาเงินกู้ที่ผ่านการอนุมัติ</li>
               <?php }elseif($method=='fail'){?>
            <h1><img src='images/icon-57.ico' width='35'><font color='blue'>  สัญญาเงินกู้ที่ไม่ผ่านการอนุมัติ </font></h1> 
            <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
              <li class="active"><i class="fa fa-edit"></i> สัญญาเงินกู้ที่ไม่ผ่านการอนุมัติ</li>
              <?php }elseif($method=='pay'){?>
            <h1><img src='images/icon-57.ico' width='35'><font color='blue'>  สัญญาเงินกู้ที่จ่ายแล้ว </font></h1> 
            <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
