...
Source Database       : savingsgroup

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2016-08-19 14:39:12
*/
...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES ('1', '1', '311/7', 'เชียงคาน', '1', '4012', '448', '30', '42110', '890277607', 'scarza@hotmail.com', '1', '2016-08-19 14:08:07');
INSERT INTO `address` VALUES ('2', '2', '001', 'khh', '1', '2008', '233', '19', '42000', '987654321', '', '1', '2016-07-12 19:07:32');
INSERT INTO `address` VALUES ('3', '3', '001', 'khhff', '1', '5048', '560', '36', '42000', '987654321', '', '1', '2016-07-30 21:07:11');
INSERT INTO `address` VALUES ('6', '6', '001', 'เชียงคาน', '2', '1978', '230', '19', '12345', '890277607', '', '1', '2016-07-30 21:07:01');
INSERT INTO `address` VALUES ('7', '1', '311/7', 'เชียงคาน', '1', '4012', '448', '30', '42110', '890277607', 'scarza@hotmail.com', '1', '2016-08-19 14:08:07');
INSERT INTO `address` VALUES ('8', '2', '001', 'เชียงคาน', '2', '5045', '559', '36', '42000', '987654321', '', '1', '2016-08-05 19:08:54');
...
CREATE TABLE `board` (
  ...
  `board_code` int(1) NOT NULL,
  `b_startdate` datetime DEFAULT NULL,
  `b_outdate` datetime DEFAULT NULL,
...
CREATE TABLE `community` (
  ...
  `hourseno` varchar(10) NOT NULL,
  `village` varchar(50) DEFAULT NULL,
  `moo` int(2) DEFAULT NULL,
  `district` int(2) NOT NULL,
  `amphur` int(2) NOT NULL,
  `province` int(2) NOT NULL,
  `post` int(5) NOT NULL,
  `tel` int(10) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `reggov_code` varchar(16) NOT NULL,
  `regist_date` date NOT NULL,
  `reg_gov_name` varchar(150) NOT NULL,
  `authorized_person` int(5) NOT NULL,
...
-- Records of contract
-- ----------------------------
INSERT INTO `contract` VALUES ('1', 'เงินกู้สามัญ', '12.00', '0.00');
INSERT INTO `contract` VALUES ('2', 'เงินกู้ฉุกเฉิน', '6.00', '0.00');
INSERT INTO `contract` VALUES ('3', 'เงินกู้เพื่อพัฒนาคุณภาพชีวิต', '6.00', '0.00');
...
CREATE TABLE `interest` (
  ...
  `status` int(1) NOT NULL COMMENT '1=ปรกติ 2=ปิดloan',
...
-- ----------------------------
-- Table structure for loan_account
-- ----------------------------
DROP TABLE IF EXISTS `loan_account`;
CREATE TABLE `loan_account` (
  `loan_acc_id` int(5) NOT NULL AUTO_INCREMENT,
  `person_id` int(5) NOT NULL,
  `loan_id` int(5) NOT NULL,
  `loan_total` decimal(10,2) NOT NULL,
  `month` int(4) NOT NULL,
  `period` decimal(6,2) NOT NULL,
  `check_pay` varchar(1) NOT NULL,
  `status` int(1) NOT NULL COMMENT '1=ปรกติ 2=ปิดloanแล้ว',
  `pay_date` datetime DEFAULT NULL,
  `payer` int(5) DEFAULT NULL,
  PRIMARY KEY (`loan_acc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of loan_account
-- ----------------------------

-- ----------------------------
-- Table structure for loan_card
-- ----------------------------
...
CREATE TABLE `loan_card` (
  ...
  `loan_total` decimal(9,2) NOT NULL,
  `loan_character` varchar(150) DEFAULT NULL,
  `note` varchar(150) DEFAULT NULL,
  `bondsman_1` int(5) DEFAULT NULL,
  `bondsman_2` int(5) DEFAULT NULL,
  `bondsman_3` int(5) DEFAULT NULL,
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('0001', 'd9f9133fb120cd6096870bc2b496805b', '81dc9bdb52d04dc20036dbd8313ed055', 'tech', '0001', 'ADMIN', '2016-08-19', '13:08:13');
...
-- Records of person
-- ----------------------------
INSERT INTO `person` VALUES ('1', '001', '9098765432123', '1', 'ผู้ดูแล', 'ระบบออมทรัพย์', '1', '1982-06-09', '1', '2', '1', '2016-08-05', '05-08-2016114-12-201511424751826-1415524122-o.png');

-- ----------------------------
-- Table structure for preface
-- ----------------------------
DROP TABLE IF EXISTS `preface`;
...
CREATE TABLE `saving_account` (
  ...
  `saving_limit` decimal(6,2) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `saving_account` VALUES ('1', '1', '0.00', '1', '200.00');
