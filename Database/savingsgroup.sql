...
CREATE TABLE `loan_card` (
  ...
  `total_loan` decimal(9,2) NOT NULL,
  `note` varchar(150) DEFAULT NULL,
  `witdawal` decimal(7,2) NOT NULL,
  `bondsman_1` varchar(5) DEFAULT NULL,
  `bondsman_2` varchar(5) DEFAULT NULL,
  `bondsman_3` varchar(5) DEFAULT NULL,
